...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('ordinaryjellyfish/sentra', function () {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.override)((flarum_forum_components_Post__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'flagReason', function (original, flag) {
    if (flag.type() === 'sentra') {
      var reason = flag.reason();
      return flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('ordinaryjellyfish-sentra.forum.flag_reason', {
        reason: reason
      });
    }
